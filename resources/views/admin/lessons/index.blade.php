...
@can('lesson_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-outline-dark" href="{{ route("admin.lessons.create") }}">
...
<div class="card-header " style="color: #ff6a00; font-weight: bold ; background-color:white;" >
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table   table-hover datatable datatable-Lesson" style="font-size:12px">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.lesson.fields.subjects') }}
                        </th>
                        <th>
                            Курсы
                        </th>
                ...
                <tbody>
                    @foreach($lessons as $key => $lesson)
                        <tr data-entry-id="{{ $lesson->id }}" class="text-center">
                            <td>
                            ...
                            <td>
                                @can('lesson_show')
                                    ...
                                    <a class="btn btn-xs btn-outline-dark " href="{{ route('admin.lessons.show', $lesson->id) }}">
                                ...
                                @can('lesson_edit')
                                    ...
                                    <a class="btn btn-xs btn-outline-dark" href="{{ route('admin.lessons.edit', $lesson->id) }}">
